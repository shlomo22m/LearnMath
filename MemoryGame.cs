...
namespace LearnMath
{
    public partial class MemoryGame : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            sql = "SELECT  top 1 PlayGameCode,GameCode,Level,UserId,MarkSize,background FROM LearnMath.dbo.StudentPlay where UserId= '" + UserId + "' and GameCode='5' ORDER BY PlayGameCode DESC";
