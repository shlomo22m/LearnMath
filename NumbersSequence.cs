...
namespace LearnMath
{
    public partial class NumbersSequence : Form
    {
        ...
        public NumbersSequence(int UserID)
        {
            InitializeComponent();
            UserId = UserID;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            sql = "SELECT  top 1 PlayGameCode,GameCode,Level,UserId,MarkSize,background FROM LearnMath.dbo.StudentPlay where UserId= '" + UserId + "' and GameCode='4' ORDER BY PlayGameCode DESC";
        ...
        private void NumbersSequence_Load(object sender, EventArgs e)
        {
